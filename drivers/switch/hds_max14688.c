...
static struct max14688_jack_match max14688_jack_matches[] = {
    ...
    JACK_MATCH("3P",     Z(0,        50000),  Z(0,   3),   false,  LOW,   LOW,   LGE_HEADSET_NO_MIC,          EV_SW, SW_HEADPHONE_INSERT, NONE),
    JACK_MATCH("4P",     Z(120000, 2600000),  Z(0,   3),   true,   HIGH,  LOW,   LGE_HEADSET,                 EV_SW, SW_HEADPHONE_INSERT, SW_MICROPHONE_INSERT),
#if MAX14688_ADVANCED_JACK_DET
    JACK_MATCH("3P/ADV", Z(0,        50000),  Z(3,   6),   false,  LOW,   LOW,   LGE_HEADSET_NO_MIC,          EV_SW, SW_HEADPHONE_INSERT, NONE),
    JACK_MATCH("4P/ADV", Z(120000, 2600000),  Z(3,   6),   true,   HIGH,  LOW,   LGE_HEADSET,                 EV_SW, SW_HEADPHONE_INSERT, SW_MICROPHONE_INSERT),
    JACK_MATCH("ACC/AUX",ANY,                 Z(6,  64),   false,  LOW,  HIGH,   LGE_HEADSET_NO_MIC,          EV_SW, SW_HEADPHONE_INSERT, NONE),
#else
#endif
};
...
static int max14688_log_level = 2;
...
out:
    if (unlikely(me->irq < 0)) {
        schedule_delayed_work(&me->irq_work,
            usecs_to_jiffies(MAX14688_POLLMODE_INTERVAL));
    }
    __unlock(me);
    return;
}
...
static SIMPLE_DEV_PM_OPS(max14688_pm, max14688_suspend,
    max14688_resume);
